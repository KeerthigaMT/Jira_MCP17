# JIRA 7.6.1 MCP Server

This MCP (Model Content Protocol) server provides access to JIRA 7.6.1 API functionality through HTTP, HTTPS, and STDIO transport modes.
